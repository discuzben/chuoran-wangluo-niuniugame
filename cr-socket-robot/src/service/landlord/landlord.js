...
module.exports = (function(ioObj, data){
    ...
    let landlordService = function(data){
        self = this;
        this.init(data);
    }

    landlordService.prototype.init = function (data){
    ...
    //该方法在初始化后都会被调用
    landlordService.prototype.__setPlayerInfo = function(info){
        this.data.playerId = info.playerId;
        this.data.playerInfo = info;
    } 

    //响应游戏事件
    landlordService.prototype.__onGameEvent = function(){
    ...
    //情况：游戏异常、游戏结束
    landlordService.prototype.__destroy = function(){
        //对象销毁
        ZR_IO.destroy();
        ZR_IO = self = null;
    }

    return new landlordService(data);
});