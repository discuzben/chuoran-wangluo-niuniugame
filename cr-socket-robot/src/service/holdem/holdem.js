...
module.exports = (function(ioObj, data){
    ...
    let holdemService = function(data){
        self = this;
        this.init(data);
    }

    holdemService.prototype.init = function (data){
    ...
    //该方法在初始化后都会被调用
    holdemService.prototype.__setPlayerInfo = function(info){
        this.data.playerId = info.playerId;
        this.data.playerInfo = info;
    } 

    //响应游戏事件
    holdemService.prototype.__onGameEvent = function(){
    ...
    //情况：游戏异常、游戏结束
    holdemService.prototype.__destroy = function(){
        //对象销毁
        ZR_IO.destroy();
        ZR_IO = self = null;
    }

    return new holdemService(data);
});